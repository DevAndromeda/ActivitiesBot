// original version: https://github.com/DjDeveloperr/ActivitiesBot
...
slash.handle("invite", (d) => {
  d.reply(
    `• [Click here to invite.](<https://discord.com/api/oauth2/authorize?client_id=674970405865390092&permissions=1&scope=applications.commands%20bot>)\n` +
    `• [Join our Discord.](<https://discord.gg/uqB8kxh>)`,
    { ephemeral: true }
  );
});
